...
[FSRS](https://github.com/open-spaced-repetition/fsrs4anki), as known as free spaced repetition scheduler, is a modern spaced repetition algorithm. It is based on [DSR model](https://supermemo.guru/wiki/Three_component_model_of_memory) proposed by [Piotr Wozniak](https://supermemo.guru/wiki/Piotr_Wozniak), the creator of SuperMemo.
